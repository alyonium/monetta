...
export const CURRENCIES_PAGE_LIMIT = 50;
...
export const CURRENCIES_QUERY_KEY = ['currency', 'list', 'v2'] as const;
...
export const CURRENCIES_MISSING_ERROR = 'Currencies are missing';
